/**
 * Generates global styles for dynamically created CSS.
 * Styles are not duplicated if the same element is used multiple times.
 *
 * From https://every-layout.dev/ Svelte implementation:
 * https://github.com/aarongeorge/svelte-every-layout
 */
